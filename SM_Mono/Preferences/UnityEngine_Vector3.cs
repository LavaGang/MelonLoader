...
{
    internal class UnityEngine_Vector3 : MelonPreferences_Entry
    {
        private static Type ReflectedType = typeof(UnityEngine.Vector3);
        private UnityEngine.Vector3 Value;
        private UnityEngine.Vector3 EditedValue;
        private UnityEngine.Vector3 DefaultValue;
        ...
        internal static void Resolve(object sender, ResolveEventArgs args)
        {
            if ((args.Entry != null)
                ...
                return;
            args.Entry = new UnityEngine_Vector3();
        }
        ...
        public override void SetValue<T>(T val)
        {
            ...
            UnityEngine.Vector3 oldval = Value;
            Value = EditedValue = Expression.Lambda<Func<UnityEngine.Vector3>>(Expression.Convert(Expression.Constant(val), ReflectedType)).Compile()();
        ...
        public override void SetEditedValue<T>(T val)
        {
            ...
            EditedValue = Expression.Lambda<Func<UnityEngine.Vector3>>(Expression.Convert(Expression.Constant(val), ReflectedType)).Compile()();
        }
        ...
        public override void SetDefaultValue<T>(T val)
        {
            ...
            DefaultValue = Expression.Lambda<Func<UnityEngine.Vector3>>(Expression.Convert(Expression.Constant(val), ReflectedType)).Compile()();
        }
        ...
        public override void Load(TomlObject obj)
        {
            ...
            if (farr.Length != 3)
                return;
            SetValue(new UnityEngine.Vector3(farr[0], farr[1], farr[2]));
        }
