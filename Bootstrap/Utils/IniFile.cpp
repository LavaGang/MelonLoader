...
void IniFile::WriteValue(std::string Section, std::string Key, std::string Patch) { WritePrivateProfileStringA(Section.c_str(), Key.c_str(), Patch.c_str(), FilePath.c_str()); }
