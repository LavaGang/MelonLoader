...
namespace MelonLoader
{
    ...
    public class MelonAuthorColorAttribute : Attribute
    {
        ...
        public MelonAuthorColorAttribute(ConsoleColor color) { Color = ((color == ConsoleColor.Black) ? LoggerUtils.DrawingColorToConsoleColor(MelonLogger.DefaultMelonColor) : color); }
        public MelonAuthorColorAttribute(int alpha, int red, int green, int blue) { DrawingColor =  System.Drawing.Color.FromArgb(alpha, red, green, blue); }
    }
}