...
public class TarArchive : IDisposable
{
    ...
    public bool AsciiTranslate
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : asciiTranslate;
        }
    ...
    public string PathPrefix
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : pathPrefix;
        }
    ...
    public string RootPath
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : rootPath;
        }
    ...
    public bool ApplyUserInfoOverrides
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : applyUserInfoOverrides;
        }
    ...
    public int UserId
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : userId;
        }
    }
    ...
    public string UserName
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : userName;
        }
    }
    ...
    public int GroupId
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : groupId;
        }
    }
    ...
    public string GroupName
    {
        get
        {
            return isDisposed ? throw new ObjectDisposedException("TarArchive") : groupName;
        }
    }
    ...
    {
        var asciiTrans = !IsBinary(destFile);
