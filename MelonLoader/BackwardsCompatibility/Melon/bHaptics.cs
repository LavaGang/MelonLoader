...
public static class bHaptics
{
    ...
    [Obsolete("MelonLoader.bHaptics.IsPlaying is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.IsPlayingAny instead. This will be removed in a future version.", true)]
    public static bool IsPlaying()
        => bHapticsLib.bHapticsManager.IsPlayingAny();
    [Obsolete("MelonLoader.bHaptics.IsPlaying(string) is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.IsPlaying instead. This will be removed in a future version.", true)]
    public static bool IsPlaying(string key)
        => bHapticsLib.bHapticsManager.IsPlaying(key);

    [Obsolete("MelonLoader.bHaptics.IsDeviceConnected(DeviceType, bool) is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.IsDeviceConnected instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.IsDeviceConnected(PositionType) is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.IsDeviceConnected instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.IsFeedbackRegistered is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.IsPatternRegistered instead. This will be removed in a future version.", true)]
    public static bool IsFeedbackRegistered(string key)
        => bHapticsLib.bHapticsManager.IsPatternRegistered(key);

    [Obsolete("MelonLoader.bHaptics.RegisterFeedback is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.RegisterPatternFromJson instead. This will be removed in a future version.", true)]
    public static void RegisterFeedback(string key, string tactFileStr)
    {
        var proxyArray = new TinyJSON.ProxyArray
        {
            ["project"] = TinyJSON.Decoder.Decode(tactFileStr)
        };
        bHapticsLib.bHapticsManager.RegisterPatternFromJson(key, TinyJSON.Encoder.Encode(proxyArray));
    }

    [Obsolete("MelonLoader.bHaptics.RegisterFeedbackFromTactFile is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.RegisterPatternFromJson instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.RegisterFeedbackFromTactFileReflected is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.RegisterPatternSwappedFromJson instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.SubmitRegistered is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.PlayRegistered instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.TurnOff is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.StopPlayingAll instead. This will be removed in a future version.", true)]
    public static void TurnOff()
        => bHapticsLib.bHapticsManager.StopPlayingAll();
    [Obsolete("MelonLoader.bHaptics.TurnOff(string) is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.StopPlaying instead. This will be removed in a future version.", true)]
    public static void TurnOff(string key)
        => bHapticsLib.bHapticsManager.StopPlaying(key);

    [Obsolete("MelonLoader.bHaptics.Submit is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.Play instead. This will be removed in a future version.", true)]
    ...
    [Obsolete]
    private static readonly Converter<DotPoint, bHapticsLib.DotPoint> DotPointConverter = new((x)
    ...
    [Obsolete]
    private static readonly Converter<PathPoint, bHapticsLib.PathPoint> PathPointConverter = new((x)
    ...
    [Obsolete("MelonLoader.bHaptics.GetCurrentFeedbackStatus is Only Here for Compatibility Reasons. Please use bHapticsLib.bHapticsManager.GetDeviceStatus instead. This will be removed in a future version.", true)]
    ...
    public static FeedbackStatus GetCurrentFeedbackStatus(PositionType pos)
        => new()
        { values = bHapticsLib.bHapticsManager.GetDeviceStatus(PositionTypeToPositionID(pos)) };

    [Obsolete("MelonLoader.bHaptics.DeviceTypeToPositionType is Only Here for Compatibility Reasons. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.DeviceType is Only Here for Compatibility Reasons. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.PositionType is Only Here for Compatibility Reasons. Please use bHapticsLib.PositionID instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.RotationOption is Only Here for Compatibility Reasons. Please use bHapticsLib.RotationOption instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.ScaleOption is Only Here for Compatibility Reasons. Please use bHapticsLib.ScaleOption instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.DotPoint is Only Here for Compatibility Reasons. Please use bHapticsLib.DotPoint instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.PathPoint is Only Here for Compatibility Reasons. Please use bHapticsLib.PathPoint instead. This will be removed in a future version.", true)]
    ...
    [Obsolete("MelonLoader.bHaptics.FeedbackStatus is Only Here for Compatibility Reasons. This will be removed in a future version.", true)]
    [StructLayout(LayoutKind.Sequential)]
