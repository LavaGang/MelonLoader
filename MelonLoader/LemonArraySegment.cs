...
public class LemonArraySegment<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable
{
    ...
    {
        return Array != null ? Array.GetHashCode() ^ Offset ^ Count : 0;
    }
    ...
    int IList<T>.IndexOf(T item)
    {
        if (Array == null)
            throw new InvalidOperationException("The underlying array is null.");
        var num = System.Array.IndexOf(Array, item, Offset, Count);
    ...
    bool ICollection<T>.Contains(T item)
    {
        return Array == null
            ? throw new InvalidOperationException("The underlying array is null.")
            : System.Array.IndexOf<T>(Array, item, Offset, Count) >= 0;
    }
    ...
    {
        return Array == null ? throw new InvalidOperationException("The underlying array is null.") : (IEnumerator<T>)new LemonArraySegmentEnumerator(this);
    }
    ...
    {
        return Array == null ? throw new InvalidOperationException("The underlying array is null.") : (IEnumerator)new LemonArraySegmentEnumerator(this);
    }
