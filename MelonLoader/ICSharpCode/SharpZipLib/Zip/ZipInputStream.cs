...
public class ZipInputStream : InflaterInputStream
{
    ...
    private static bool IsEntryCompressionMethodSupported(ZipEntry entry)
    {
        ...
        return entryCompressionMethod is CompressionMethod.Deflated or
    ...
    public ZipEntry GetNextEntry()
    {
        ...
        if (header is ZipConstants.CentralHeaderSignature or
        ZipConstants.EndOfCentralDirectorySignature or
        ZipConstants.CentralHeaderDigitalSignature or
        ZipConstants.ArchiveExtraDataSignature or
        ...
        if (header is ZipConstants.SpanningTempSignature or ZipConstants.SpanningSignature)
        {
        ...
        var name = ZipStrings.ConvertToStringExt(flags, buffer);
    ...
    private int InitialRead(byte[] destination, int offset, int count)
    {
        ...
        if (entry.IsCrypted)
        {
            ...
            var key = PkzipClassic.GenerateKeys(ZipStrings.ConvertToArray(password));
