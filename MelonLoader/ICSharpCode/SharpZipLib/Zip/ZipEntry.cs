...
public class ZipEntry
{
        ...
        CompressionMethod method)
    {
        ...
        if (versionRequiredToExtract is not 0 and < 10)
        {
    ...
    public bool IsDOSEntry
        => HostSystem is ((int)HostSystemID.Msdos) or ((int)HostSystemID.WindowsNT);
    ...
    public long DosTime
    {
        ...
        set
        {
            unchecked
            {
                ...
                var mon = Math.Max(1, Math.Min(12, (uint)(value >> 21) & 0xf));
                var year = ((dosTime >> 25) & 0x7f) + 1980;
                var day = Math.Max(1, Math.Min(DateTime.DaysInMonth((int)year, (int)mon), (int)((value >> 16) & 0x1f)));
    ...
    public static bool IsCompressionMethodSupported(CompressionMethod method)
        => method is CompressionMethod.Deflated
    or CompressionMethod.Stored
    or CompressionMethod.BZip2;
