...
public static class ZipStrings
{
    static ZipStrings()
    {
        try
        {
            ...
            SystemDefaultCodePage = (platformCodepage is 1 or 2 or 3 or 42) ? FallbackCodePage : platformCodepage;
        }
        catch
        {
    ...
    public static bool UseUnicode
    {
        ...
        set
        {
            codePage = value ? Encoding.UTF8.CodePage : SystemDefaultCodePage;
        }
    }
