...
namespace MelonLoader
{
    public static class UnhollowerSupport
    {
        ...
        static UnhollowerSupport()
        {
            ...
            ClassInjectorRegisterTypeInIl2Cpp = UnhollowerBaseLib.GetType("UnhollowerRuntimeLib.ClassInjector").GetMethods().First(x => (x.Name.Equals("RegisterTypeInIl2Cpp") && x.IsGenericMethod && (x.GetParameters().Count() == 1)));
