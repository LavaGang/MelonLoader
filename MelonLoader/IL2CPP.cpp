...
void IL2CPP::Setup()
{
	...
	MetadataCache_GetTypeInfoFromTypeDefinitionIndex = (MetadataCache_GetTypeInfoFromTypeDefinitionIndex_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 57 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 89 74 24 ? 48 63 F9 83");
	// Audica
	if (MetadataCache_GetTypeInfoFromTypeDefinitionIndex == NULL)
		MetadataCache_GetTypeInfoFromTypeDefinitionIndex = (MetadataCache_GetTypeInfoFromTypeDefinitionIndex_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 57 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 63 F9 83 FF FF 75 04 33");


	// VRChat | Boneworks
	MetadataCache_FromTypeDefinition = (MetadataCache_FromTypeDefinition_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 53 41 54 41 56 48 83 EC 40 48 8B 05 ? ? ? ? 48 89 74 24 ? 48 89 7C 24 ? 48 63 F9 B9");
	// Audica | Pistol Whip
	if (MetadataCache_FromTypeDefinition == NULL)
		MetadataCache_FromTypeDefinition = (MetadataCache_FromTypeDefinition_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC 20 48 8B 05 ? ? ? ? 48 63 F1 B9");

	
	// VRChat
	MetadataLoader_LoadMetadataFile = (MetadataLoader_LoadMetadataFile_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 9C 24 ? ? ? ? 4C 8B F1 33");
	// Boneworks
	if (MetadataLoader_LoadMetadataFile == NULL)
		MetadataLoader_LoadMetadataFile = (MetadataLoader_LoadMetadataFile_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "48 8B C4 55 48 8D 68 A1 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 58 08 48 89 78 18");
	// Audica
	if (MetadataLoader_LoadMetadataFile == NULL)
		MetadataLoader_LoadMetadataFile = (MetadataLoader_LoadMetadataFile_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 57 41 54 41 55 41 56 41 57 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 49 8B E8 4C");
	// Pistol Whip
	if (MetadataLoader_LoadMetadataFile == NULL)
		MetadataLoader_LoadMetadataFile = (MetadataLoader_LoadMetadataFile_t)PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "40 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 9C 24 ? ? ? ? 4C 8B F1 45 33 FF 44 89 7D 77 48 8D 4D FF E8");


	// VRChat | Boneworks
	uintptr_t movInstructionPtr = PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "48 89 05 ? ? ? ? 48 8B 05 ? ? ? ? 48 63 48 34 48 B8 ? ? ? ? ? ? ? ? 48 F7 E1 48 8B CA 48 C1 E9 04 BA ? ? ? ? E8 ? ? ? ? 48 89 05");
	// Pistol Whip
	if (movInstructionPtr == NULL)
		movInstructionPtr = PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "48 89 05 ? ? ? ? 48 8B 05 ? ? ? ? 48 63 48 34 48 C1 E9 05 BA ? ? ? ? E8 ? ? ? ? 48 89 05 ? ? ? ? 48 8B 05");
	// Audica
	if (movInstructionPtr == NULL)
		movInstructionPtr = PointerUtils::FindPattern(MelonLoader::GameAssemblyDLL, "48 89 05 ? ? ? ? 48 8B 05 ? ? ? ? 48 63 48 34 48 B8 ? ? ? ? ? ? ? ? 48 F7 E1 48 8B CA 48 C1 E9 04 BA ? ? ? ? FF 15 ? ? ? ? 48 89 05");
	s_TypeInfoDefinitionTable = PointerUtils::ResolvePtrOffset((movInstructionPtr + 3), (movInstructionPtr + 7));
}