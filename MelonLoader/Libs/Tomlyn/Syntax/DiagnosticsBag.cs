...
namespace MelonLoader.Tomlyn.Syntax
{
    ...
    public class DiagnosticsBag : IEnumerable<DiagnosticMessage>
    {
        ...
        /// </summary>
        public DiagnosticsBag() => _messages = new List<DiagnosticMessage>();
        ...
        /// </summary>
        /// <returns></returns>
        public List<DiagnosticMessage>.Enumerator GetEnumerator() => _messages.GetEnumerator();

        IEnumerator<DiagnosticMessage> IEnumerable<DiagnosticMessage>.GetEnumerator() => GetEnumerator();
