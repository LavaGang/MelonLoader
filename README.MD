...
3. Remove the Plugins folder from the Game's Installation Folder.
4. Remove the Mods folder from the Game's Installation Folder.
...
| --melonloader.chromium | Magenta Console Color |
