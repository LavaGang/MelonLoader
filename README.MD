...
4. Select and Open your Unity Game's EXE.
5. Select which Version of MelonLoader to install.  (Or leave it as-is for the Latest Version.)
6. Click the INSTALL or REINSTALL button.
...
- [TinyJSON](https://github.com/pbhogan/TinyJSON) is licensed under the MIT License. See [LICENSE](https://github.com/HerpDerpinstine/MelonLoader/blob/master/MelonLoader.GeneratorProcess/TinyJSON/LICENSE.md) for the full License.
