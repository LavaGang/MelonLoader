use std::{error::Error, ffi::c_void, sync::{LazyLock, Mutex}, ptr::{addr_of_mut, null_mut, addr_of}};

use netcorehost::{nethost::load_hostfxr, pdcstr};

use crate::{environment, utils::{self, strings::wide_str}, debug, icalls};
...
pub static IMPORTS: LazyLock<Mutex<HostImports>> = LazyLock::new(|| Mutex::new(HostImports {
