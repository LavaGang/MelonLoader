...
7. Console Logs randomly do not Color properly.
...
8. Add Android Support.
9. Add Linux Support.
10. Add Mac OS Support.
...
14. Added Built-In QuitFix.  (For Games like VRChat where the Process Hangs after telling it to Exit)
