...
internal static class SceneHandler
{
    ...
    private static readonly Queue<SceneInitEvent> scenesLoaded = new();
    ...
    internal static void Init()
    {
        ...
        {
            MelonLogger.Error($"SceneManager.sceneLoaded override failed: {ex}");
        }
        ...
        {
            MelonLogger.Error($"SceneManager.sceneUnloaded override failed: {ex}");
        }
    }
    ...
    internal static void OnUpdate()
    {
        ...
        {
            var requeue = new Queue<SceneInitEvent>();
            SceneInitEvent evt;
