    ...
    internal class ExecutablePackage : PackageBase
    {
        ...
        internal bool Execute(string[] args, bool parenthesize_args = true, Dictionary<string, string> environment = null)
        {
            ...
            try
            {
                ...
                AssemblyGenerator.Logger.Msg("\"" + ExeFilePath + "\" " + processStartInfo.Arguments);
        ...
        private static void OutputStream(object sender, DataReceivedEventArgs e) { if (e.Data == null) ResetEvent_Output.Set(); else AssemblyGenerator.Logger.Msg(e.Data); }
        private static void ErrorStream(object sender, DataReceivedEventArgs e) { if (e.Data == null) ResetEvent_Error.Set(); else AssemblyGenerator.Logger.Error(e.Data); }
