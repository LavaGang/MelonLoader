...
{
    private readonly Dictionary<MelonBase, object> ModInformation = [];
    ...
    private void OnPreAppStart()
    {
        try
        {
            ...
            var moddingApi = assembly.GetType("Boardgame.Modding.ModdingAPI");
            ...
            var externalModsField = moddingApi.GetField("ExternallyInstalledMods", BindingFlags.Public | BindingFlags.Static);
